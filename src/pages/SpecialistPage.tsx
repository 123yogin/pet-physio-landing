        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <p className="font-['Inter'] text-sm text-[#504440] font-light leading-relaxed">
              {specialist.name} practises at {SITE.brandName} in {SITE.address.addressLocality}, working alongside the
              wider rehabilitation team on referral cases coordinated with each patient's primary veterinarian.
            </p>
          </div>
        </div>
